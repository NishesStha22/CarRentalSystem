...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <div style="float: left"><p><b>Message:</b> <?php echo htmlentities($result->message);?> </p> <?php if($result->Status==1)
                { ?><a href="#" class="btn outline btn-xs active-btn">Confirmed</a> <?php } ?></div>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="payment.php?bookingnum=<?php echo htmlentities($result->BookingNumber);?>" class="btn outline btn-xs active-btn">PRINT</a>
