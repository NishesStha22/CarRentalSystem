...
$querys->execute();
$resultis=$querys->fetchAll(PDO::FETCH_OBJ);
$cnt=$querys->rowCount();
?>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img" style='height:100%; object-fit:cover' > <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
...
<a href="#top"><i class="fa fa-angle-up" aria-hidden="true"></i> </a> </div>
<!--/Back to top--> 
